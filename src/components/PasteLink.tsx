                ...
                <form onSubmit={handleSubmit(onSubmit)} className="">
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <div className='flex flex-row items-center justify-between  bg-white rounded-full gap-2 drop-shadow-lg'>
                            ...
                            <label htmlFor="pasteLink"><HiOutlineLink style={{ color: '#766FF9' }} size={20} className="ml-5 sm:ml-4 cursor-pointer" /></label>
                            ...
                            <input type="submit" value="Shorten" className='py-2 px-5 mr-3 cursor-pointer bg-[#766FF9] hover:bg-[#041267] duration-500 ease-in-out rounded-full shadow-lg text-white text-sm' />
            ...
            {isShortened && (
                <div className="flex flex-col items-center gap-4">
                    <div className='flex flex-row items-center justify-between bg-white rounded-full py-2 px-3 hover:bg-gray-200 duration-500 ease-in-out max-w-[20rem] sm:max-w-[35rem]'>
                        <label htmlFor="copy" className='text-black font-semi-bold cursor-pointer truncate'>{`poppins.in/${OutputLink}`}</label>
                        <button id='copy' type='button' onClick={HandleOnCopy}>
                            <MdContentCopy style={{ color: '#766FF9' }} size={20} className="ml-5 sm:ml-4" />
                        </button>
                    </div>

                    <input type="button" value="Shorten More Link!" onClick={newLink} className='py-2 px-5 cursor-pointer bg-[#766FF9] hover:bg-[#041267] duration-500 ease-in-out  rounded-full shadow-lg text-white text-sm' />
                </div>
            )}
