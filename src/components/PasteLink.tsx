          ...
          <div className="flex flex-col gap-2">
            <div className="flex flex-row items-center justify-between  bg-white rounded-full gap-2 drop-shadow-lg">
              ...
              <input
                type="submit"
                value="Shorten"
                className="py-2 px-5 mr-3 cursor-pointer bg-[#766FF9] rounded-full shadow-lg text-white text-sm"
              />
            </div>
      ...
      {isShortened && (
        <div className="flex flex-col items-center gap-2">
          <div className="flex flex-row items-center justify-between bg-white rounded-full py-2 px-3">
            <label
              htmlFor="copy"
              className="text-black font-semi-bold cursor-pointer"
          ...
          <input
            ...
            onClick={newLink}
            className="py-2 px-5 cursor-pointer bg-[#766FF9] rounded-full shadow-lg text-white text-sm"
          />
        </div>
      )}
    </>
